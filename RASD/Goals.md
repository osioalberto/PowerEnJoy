...
* [G2 bis] Non registered users must not be able to log in to the system
...
* [G7bis] No user except the reservor user, if exists, is able to enter a locked car
...
* [G12] When a car is becoming available, then the bill can be charged to the reservor user
