...
* **Applying a raise** or **a discount**: These operation are delayed untill immediately before the system charges the user for a bill, in exactly this moment these operation are evaluated on the bill and then algebraically added to the bill